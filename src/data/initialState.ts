...
export const initialSlides: Slide[] = [
  ...
  { id: 'slide-results-ab', type: 'matchResults', title: '試合結果速報（A・B）', duration: 14, enabled: true, courts: ['A', 'B'], note: DEFAULT_RESULTS_NOTE },
  { id: 'slide-results-cd', type: 'matchResults', title: '試合結果速報（C・D）', duration: 14, enabled: true, courts: ['C', 'D'], note: DEFAULT_RESULTS_NOTE },
  { id: 'slide-results-ef', type: 'matchResults', title: '試合結果速報（E・F）', duration: 14, enabled: true, courts: ['E', 'F'], note: DEFAULT_RESULTS_NOTE },
  {
    id: 'slide-notice',
    type: 'notice',
    title: 'お知らせ',
